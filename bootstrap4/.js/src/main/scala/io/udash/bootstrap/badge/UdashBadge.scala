...
private[badge] class UdashBadgeLink(
  ...
  override protected def baseTag: TypedTag[Element] =
    a(nestedInterceptor(href.bind(link)))
}

object UdashBadge {

  /** Creates a badge component. More: <a href="http://getbootstrap.com/docs/4.1/components/badge/">Bootstrap Docs</a>.
    *
    * @param badgeStyle
  ...
  /** Creates a badge link component. More: <a href="http://getbootstrap.com/docs/4.1/components/badge/">Bootstrap
    * Docs</a>.
    *
    * @param link
