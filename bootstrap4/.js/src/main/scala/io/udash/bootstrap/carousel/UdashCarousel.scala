...
object UdashCarousel {
  ...
  /** Creates a carousel component. More: <a href="http://getbootstrap.com/docs/4.1/components/carousel/">Bootstrap
    * Docs</a>.
    *
    * @param slides
  ...
  /** Creates the UdashCarousel component consisting of `UdashCarouselSlide`. More: <a
    * href="http://getbootstrap.com/docs/4.1/components/carousel/">Bootstrap Docs</a>.
    *
    * @param slides
    *   A SeqProperty of carousel slides.
    * @param showIndicators
  ...
  final case class CarouselEvent[ItemType, ElemType <: ReadableProperty[ItemType]](
    source: UdashCarousel[ItemType, ElemType],
    targetIndex: Int,
    direction: Direction,
    changed: Boolean,
  ...
  /** [[UdashCarousel]] animation options.
    ...
    * @param pause
    *   Indicated whether the carousel should pass on some specific event. See
    *   [[UdashCarousel.AnimationOptions.PauseOption]].
    * @param wrap
  ...
  final case class AnimationOptions(
    ...
    pause: PauseOption = PauseOption.Hover,
    wrap: Boolean = true,
