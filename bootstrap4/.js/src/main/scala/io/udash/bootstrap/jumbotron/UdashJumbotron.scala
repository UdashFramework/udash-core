...
object UdashJumbotron {
  ...
  /** Creates a jumbotron component. More: <a href="http://getbootstrap.com/docs/4.1/components/jumbotron/">Bootstrap
    * Docs</a>.
    *
    * @param fluid
    *   If true, applies `jumbotron-fluid` style.
    * @param componentId
    *   An id of the root DOM node.
    * @param content
    *   A jumbotron content. Use the provided interceptor to properly clean up bindings inside the content.
    * @return
    *   A `UdashJumbotron` component, call `render` to create a DOM element.
    */
  def apply(
