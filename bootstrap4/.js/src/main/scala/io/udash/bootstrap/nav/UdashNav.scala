...
final class UdashNav[ItemType, ElemType <: ReadableProperty[ItemType]] private (
  ...
  override val render: Element =
    ul(
      ...
      nestedInterceptor(
        BootstrapStyles.Navigation.justifyCenter.styleIf(align.transform(_ == BootstrapStyles.Align.Center))
      ),
...
object UdashNav {
  ...
  val defaultItemFactory: (ReadableProperty[NavItem], Binding.NestedInterceptor) => Element = { (item, nested) =>
    a(
  ...
  /** Creates a navigation component. More: <a href="http://getbootstrap.com/docs/4.1/components/navs/">Bootstrap
    * Docs</a>.
    *
    * @param panels
    ...
    * @param elemFactory
    *   Creates DOM hierarchy representing an element in the navigation. Use the provided interceptor to properly clean
    *   up bindings inside the content. Usually you should add the `BootstrapStyles.Navigation.link` style to your
    *   links.
    * @param isActive
  ...
  /** Creates a navigation component based on the default `NavItem`. More: <a
    * href="http://getbootstrap.com/docs/4.1/components/navs/">Bootstrap Docs</a>.
    *
    * @param panels
    *   Sequence of elements to be converted into navigation.
    * @param align
