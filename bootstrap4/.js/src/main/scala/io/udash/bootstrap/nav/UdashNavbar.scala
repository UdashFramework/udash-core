...
final class UdashNavbar[ItemType, ElemType <: ReadableProperty[ItemType]] private (
  ...
  override val render: Element =
    tags2
      .nav(
        componentId,
        BootstrapStyles.NavigationBar.navbar,
...
object UdashNavbar {
  ...
  /** Creates a default, responsive navigation bar. More: <a
    * href="http://getbootstrap.com/docs/4.1/components/navbar/">Bootstrap Docs</a>.
    *
    * @param expandBreakpoint
    *   Screen size breakpoint to switch between collapsed and expanded menu.
    * @param darkStyle
    *   If true, enables dark navigation bar theme.
    * @param backgroundStyle
    *   Selects navigation bar background style.
    * @param position
    *   Sets bar position.
    * @param componentId
    *   An id of the root DOM node.
    * @param navigationFactory
    *   Navigation component factory - if you want to clean up the created navigation on the navigation bar cleanup pass
    *   it to the provided interceptor.
    * @param brand
    *   A brand DOM element.
    * @tparam ItemType
    ...
    * @return
    *   A `UdashNavbar` component, call `render` to create a DOM element.
    */
  def apply[ItemType, ElemType <: ReadableProperty[ItemType]](
    expandBreakpoint: ReadableProperty[BootstrapStyles.ResponsiveBreakpoint] =
      BootstrapStyles.ResponsiveBreakpoint.Large.toProperty,
  ...
  /** Creates a default, responsive navigation bar. More: <a
    ...
    *   An id of the root DOM node.
    * @param navigationFactory
    *   Navigation content factory - if you want to clean up the created navigation on the navigation bar cleanup pass
    *   it to the provided interceptor. The returned modifier is applied to the collapsible navigation container.
