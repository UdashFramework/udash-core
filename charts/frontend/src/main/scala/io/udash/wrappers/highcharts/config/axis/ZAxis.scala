...
class ZAxis extends Axis[ZAxis, ZAxisEvents] {
  /**
    ...
    * If the same point name is repeated in the same or another series, the point is placed on the same X position
    * as other points of the same name. When nameToX is false, the points are laid out in increasing X positions regardless
...
object ZAxis {
  ...
  /**
    ...
    * @param nameToX                Applies only when the axis type is category. When nameToX is true, points are placed on the X axis according to their names. If the same point name is repeated in the same or another series, the point is placed on the same X position as other points of the same name. When nameToX is false, the points are laid out in increasing X positions regardless of their names, and the X axis category will take the name of the last point in each position. Defaults to true.
  ...
  def apply(allowDecimals: js.UndefOr[Boolean] = js.undefined,
            ...
            events: js.UndefOr[ZAxisEvents] = js.undefined,
            ...
            labels: js.UndefOr[ZAxisLabel] = js.undefined,
            ...
            plotBands: js.UndefOr[Seq[ZAxisPlotBand]] = js.undefined,
            ...
            visible: js.UndefOr[Boolean] = js.undefined): ZAxis = {
