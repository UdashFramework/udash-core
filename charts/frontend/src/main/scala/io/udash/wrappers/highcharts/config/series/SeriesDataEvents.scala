...
object SeriesDataEvents {
  ...
  /**
    ...
    */
  def apply(click: js.UndefOr[(api.Point, JQueryEvent) => Boolean] = js.undefined,
            mouseOut: js.UndefOr[(api.Point, JQueryEvent) => Any] = js.undefined,
            mouseOver: js.UndefOr[(api.Point, JQueryEvent) => Any] = js.undefined,
            remove: js.UndefOr[(api.Point, JQueryEvent) => Boolean] = js.undefined,
            select: js.UndefOr[(api.Point, JQueryEvent) => Boolean] = js.undefined,
            unselect: js.UndefOr[(api.Point, JQueryEvent) => Boolean] = js.undefined,
            update: js.UndefOr[(api.Point, SeriesDataEvents.UpdateEvent) => Boolean] = js.undefined): SeriesDataEvents = {
    val clickOuter = click.map(ThisFunction.fromFunction2[api.Point, JQueryEvent, Boolean])
    val mouseOutOuter = mouseOut.map(ThisFunction.fromFunction2[api.Point, JQueryEvent, Any])
    val mouseOverOuter = mouseOver.map(ThisFunction.fromFunction2[api.Point, JQueryEvent, Any])
    val removeOuter = remove.map(ThisFunction.fromFunction2[api.Point, JQueryEvent, Boolean])
    val selectOuter = select.map(ThisFunction.fromFunction2[api.Point, JQueryEvent, Boolean])
    val unselectOuter = unselect.map(ThisFunction.fromFunction2[api.Point, JQueryEvent, Boolean])
    val updateOuter = update.map(ThisFunction.fromFunction2[api.Point, SeriesDataEvents.UpdateEvent, Boolean])
