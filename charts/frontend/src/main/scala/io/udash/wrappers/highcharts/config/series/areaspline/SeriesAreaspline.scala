...
class SeriesAreaspline extends AreaLineSeries {
  ...
  override val `type`: String = "areaspline"
...
object SeriesAreaspline {
  ...
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined,
            ...
            zones: js.UndefOr[Seq[SeriesZone]] = js.undefined): SeriesAreaspline = {
    ...
    val dataOuter = data.toJSArray.asInstanceOf[js.UndefOr[SeriesAreaspline#Data]]
