...
package config
package series.areaspline

import io.udash.wrappers.highcharts.config.series.area.SeriesAreaData
import io.udash.wrappers.highcharts.config.series.{SeriesDataEvents, SeriesDataLabels, SeriesDataMarker}
import io.udash.wrappers.highcharts.config.utils.Color

import scala.scalajs.js

@js.annotation.ScalaJSDefined
class SeriesAreasplineData extends SeriesAreaData
...
object SeriesAreasplineData {
  ...
  def apply(color: js.UndefOr[Color] = js.undefined,
            ...
            y: js.UndefOr[Double] = js.undefined): SeriesAreasplineData = {
