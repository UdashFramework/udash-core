...
import io.udash.wrappers.highcharts.config.series.arearange.SeriesArearangeData
import io.udash.wrappers.highcharts.config.series.{SeriesDataEvents, SeriesRangeDataLabels}
...
object SeriesAreasplinerangeData {
  ...
  def apply(color: js.UndefOr[Color] = js.undefined,
            ...
            x: js.UndefOr[Double] = js.undefined): SeriesAreasplinerangeData = {
