...
object SeriesScatter {
  ...
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined,
            ...
            zones: js.UndefOr[Seq[SeriesZone]] = js.undefined): SeriesScatter = {
    ...
    val dataOuter = data.toJSArray.asInstanceOf[js.UndefOr[SeriesScatter#Data]]
