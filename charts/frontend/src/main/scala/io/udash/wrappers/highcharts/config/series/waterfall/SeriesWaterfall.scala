...
object SeriesWaterfall {
  ...
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined,
            ...
            upColor: js.UndefOr[Color] = js.undefined,
            ...
            zones: js.UndefOr[Seq[SeriesZone]] = js.undefined): SeriesWaterfall = {
    ...
    val dataOuter = data.toJSArray.asInstanceOf[js.UndefOr[SeriesWaterfall#Data]]
    ...
    val upColorOuter = upColor.map(_.c)
    ...
    new SeriesWaterfall {
      ...
      override val upColor = upColorOuter
