...
object FileInput {
  ...
  /** Creates a file input providing information about the selected file.
    *
    * @param selectedFile
    *   This property contains information about the file selected by user.
    * @param inputName
    *   Input element name.
    * @param inputModifiers
    *   Additional modifiers to apply on a generated input.
    * @return
    */
  ...
  /** Creates file input providing information about selected files.
    *
    * @param selectedFiles
    *   This property contains information about files selected by user.
  ...
  def apply(
    ...
    acceptMultipleFiles: ReadableProperty[Boolean],
  )(
    inputName: String,
