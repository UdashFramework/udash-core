...
case object BootstrappingIntroViewFactory
  extends StaticViewFactory[BootstrappingIntroState.type](() => new BootstrappingIntroView)
...
class BootstrappingIntroView extends View with CssView {
  ...
  override def getTemplate: Modifier = div(
    ...
    ClickableImageFactory(
      ...
      GuideStyles.floatRight,
      GuideStyles.imgSmall,
      GuideStyles.imgIntro,
    ),
    ul(GuideStyles.defaultList)(
      li(
        ...
        " interfaces, shared model and logic (e.g. model validation). ",
      ...
      li(
        ...
        " - contains ",
        a(href := RpcIntroState.url)("RPC"),
        " implementation and the whole backend application logic. ",
        "It is compiled to bytecode only. You can write your backend logic like database access, services layer etc. there.",
      ),
      li(
        i("frontend"),
        " - contains frontend application code. It is compiled to JS only and packaged into two files: ",
        i("frontend-deps.js"),
        " and ",
        i("frontend-impl.js"),
        ".",
    ...
    ClickableImageFactory(
      ...
      "More complex modules structure.",
      GuideStyles.imgBig,
      GuideStyles.frame,
    ),
    h2("What's next?"),
