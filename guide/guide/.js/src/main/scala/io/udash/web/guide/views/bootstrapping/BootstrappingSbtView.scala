...
case object BootstrappingSbtViewFactory
  extends StaticViewFactory[BootstrappingSbtState.type](() => new BootstrappingSbtView)
  ...
  override def getTemplate: Modifier =
    div(
      ...
      ul(GuideStyles.defaultList)(
        ...
        li(
          i("compileStatics"),
          " - produces whole frontend application with fast JS optimization (includes copyAssets).",
        ),
      ...
      p(
        "You can go to the ",
        a(href := AdvancedBootstrappingSbtState.url)("advanced bootstrapping section"),
