...
final class I18NExtView extends View with CssView {
  ...
  override def getTemplate: Modifier = div(
    ...
    p(
      i("TranslationKey"),
      " knows the count and types of the arguments. In the above example, ",
      i("retriesLeft"),
      " key expects one integer as the argument.",
    ),
    p(
      "It is possible to transform translation key with arguments to ",
      i("TranslationKey0"),
      " by ",
      i(".apply"),
      "ing the arguments on it. You can also pass an ",
      i("Untranslatable"),
      " as ",
      i("TranslationKey0"),
      " instance in order to use raw string instead of translated key.",
    ),
    ...
    p(
      ...
      i("TranslationProvider"),
      " instance to compile. The Udash i18n plugin provides two ",
      i("TranslationProviders"),
      ": ",
      i("LocalTranslationProvider"),
      " and ",
      i("RemoteTranslationProvider"),
      ".",
    ),
    h3("LocalTranslationProvider"),
    p(
      i("LocalTranslationProvider"),
      " was prepared for frontend-only applications. It takes a map from ",
      i("Lang"),
      " to ",
      i("Bundle"),
    ...
    p(
      ...
      i("translated"),
      " method to bind translation into DOM hierarchy. ",
    ),
    ...
    p(
      ...
      i("RemoteTranslationProvider"),
      " takes ",
      i("RemoteTranslationRPC"),
      " as constructor argument. It allows the frontend application ",
    ...
    p(
      "Let's start with ",
      i("RemoteTranslationRPC"),
      " implementation in the server application. Add the following method in your server RPC interface: ",
    ),
    AutoDemo.snippet(serverRpcSource),
    p(
      "The Udash i18n plugin makes ",
      i("RemoteTranslationRPC"),
      " easier, because it provides ",
      i("TranslationRPCEndpoint"),
      " and ",
      i("ResourceBundlesTranslationTemplatesProvider"),
      " classes.",
    ),
    CodeBlock(
    ...
    p(
      i("ResourceBundlesTranslationTemplatesProvider"),
      " expects ",
      i("Map[Lang, Seq[ju.ResourceBundle]]"),
      " as a constructor argument, whereas ",
      i("TranslationRPCEndpoint"),
      " takes ",
      i("ResourceBundlesTranslationTemplatesProvider"),
      " instance. ",
    ...
    p(
      ...
      i("RemoteTranslationProvider"),
      ". This provider loads required translation templates from server ",
    ...
    h3("Dynamic binding"),
    p(
      "Dynamic binding is able to update translation after the change of ",
      i("LangProperty"),
      ".",
      ul(GuideStyles.defaultList)(
        li(
          i("translatedDynamic"),
          " - binds translated string in the DOM element and updates it when the application language changes.",
        ),
        li(
          i("translatedAttrDynamic"),
          " - binds translated string in the DOM element attribute and updates it when the application language changes.",
        ),
      ),
