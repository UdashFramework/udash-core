...
object IntroFormDemo extends AutoDemo {
  ...
  private val (rendered, source) = {
    ...
    /** The form's model structure. case class IntroFormDemoModel(minimum: Int, between: Int, maximum: Int) object
      * IntroFormDemoModel extends HasModelPropertyCreator[IntroFormDemoModel]
      */
    ...
    class IntroFormDemoPresenter(model: ModelProperty[IntroFormDemoModel]) extends Presenter[IntroFormDemoState.type] {
    ...
    class IntroFormDemoView(model: ModelProperty[IntroFormDemoModel], presenter: IntroFormDemoPresenter) extends View {
      ...
      randomizeButton.listen { case UdashButton.ButtonClickEvent(_, _) =>
        presenter.randomize()
      }
