...
private[views] object IndexView {
  ...
  private def sectionFactory(sectionContent: Modifier*): JsDom.TypedTag[Element] = {
    section(HomepageStyles.sectionIntro)(
  ...
  val sectionIntro: JsDom.TypedTag[Element] = sectionFactory(
  ...
  val sectionFeatures: JsDom.TypedTag[Element] = sectionFactory(
    h1(
  ...
  private val sectionMore: JsDom.TypedTag[Element] = sectionFactory(
    h1("Why Udash?"),
  ...
  private def sectionDemo(state: Property[IndexState]): JsDom.TypedTag[Element] = sectionFactory(
