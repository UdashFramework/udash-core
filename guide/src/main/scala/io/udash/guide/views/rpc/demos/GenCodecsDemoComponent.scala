package io.udash.guide.views.rpc.demos

import io.udash.guide.Context
import io.udash._
import io.udash.guide.demos.rpc.GenCodecServerRPC
...
trait GenCodecsDemoModel {
  import io.udash.guide.demos.rpc.GenCodecServerRPC._
