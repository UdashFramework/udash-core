...
object DynamicRemoteTranslationsDemo {
  ...
  def apply(): dom.Element = {
    ...
    div(id := "dynamic-rpc-translations-demo", GuideStyles.frame)(
      button(BootstrapStyles.btn, BootstrapStyles.btnPrimary)(id := "enButton", onclick := ((_: Event) => lang.set(Lang("en"))))("EN"), " ",
      button(BootstrapStyles.btn, BootstrapStyles.btnPrimary)(id := "plButton", onclick := ((_: Event) => lang.set(Lang("pl"))))("PL"),
      ul(
