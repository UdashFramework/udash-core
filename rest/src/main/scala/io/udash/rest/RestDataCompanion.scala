 ...
 * [[io.udash.rest.openapi.RestSchema RestSchema]] that will be <b>named</b> and used
 * as a reference in OpenAPI model.
 * {{{
 ...
 * }}}
 *
 * [[io.udash.rest.openapi.RestSchema RestSchema]] instance generated by default for
 * enums is inlined, see [[RestSchema.namedEnumSchema]].
 */
