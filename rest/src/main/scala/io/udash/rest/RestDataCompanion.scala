 ...
 * [[RestSchema]] that will be <b>named</b> and used as a reference in OpenAPI model.
 * {{{
 ...
 * }}}
 *
 * [[RestSchema]] instance generated by default for enums is inlined, see [[RestSchema.namedEnumSchema]].
 */
...
/**
 * Like [[RestValueEnumCompanion]] but for [[NamedEnum]] types (enums whose cases are identified by an
 * explicit `name` rather than by their declaration). Automatically provides a <b>named</b>
 * [[RestSchema]] used as a reference in the OpenAPI model.
 *
