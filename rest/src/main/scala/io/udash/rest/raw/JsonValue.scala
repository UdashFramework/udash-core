...
/** Value used as encoding of [[io.udash.rest.Body Body]] parameters of [[io.udash.rest.JsonBody JsonBody]] methods.
  * Wrapped value MUST be a valid JSON.
  */
final case class JsonValue(value: String) extends AnyVal
