...
object AtmosphereRequest {
  def apply(
    ...
    fallbackMethod: Method.Method = Method.GET,
    headers: js.Array[js.Any] = js.Array(),
    contentType: String = "",
    data: String = "",
    suspend: Boolean = true,
    maxRequest: Int = -1,
    maxStreamingLength: Int = 10000000,
    logLevel: String = "info",
    transport: Transport.Transport = Transport.LONG_POLLING,
    fallbackTransport: Transport.Transport = Transport.LONG_POLLING,
    webSocketImpl: js.Any = null,
    webSocketPathDelimiter: String = "@@",
    enableXDR: Boolean = false,
    rewriteURL: Boolean = false,
    attachHeadersAsQueryString: Boolean = true,
    dropHeaders: Boolean = true,
    executeCallbackBeforeReconnect: Boolean = false,
    withCredentials: Boolean = false,
    trackMessageLength: Boolean = false,
    messageDelimiter: String = "|",
    shared: Boolean = false,
    enableProtocol: Boolean = true,
    readResponseHeaders: Boolean = false,
    maxReconnectOnClose: Int = 5,
    pollingInterval: Int = 0,
    heartbeatServer: Int = 0,
    closeAsync: Boolean = false,
    ackInterval: Int = 0,
    reconnectOnServerError: Boolean = true,
    reconnectOnWindowLocationChange: Boolean = false,
    ...
    onMessagePublished: js.Function2[AtmosphereRequest, AtmosphereResponse, Any] = (
      _: AtmosphereRequest,
      _: AtmosphereResponse,
    ) => {},
