...
abstract class ServerRpcCompanion[Deps, ServerRpc](
  deps: Deps
...
abstract class ClientRpcCompanion[Deps, ClientRpc](
  deps: Deps
...
abstract class DefaultServerRpcCompanionWithDeps[Deps, ServerRpc](
  implicit instances: MacroInstances[(Deps, DefaultUdashSerialization), ServerRpcInstances[ServerRpc]],
...
abstract class DefaultClientRpcCompanionWithDeps[Deps, ClientRpc](
  implicit instances: MacroInstances[(Deps, DefaultUdashSerialization), ClientRpcInstances[ClientRpc]],
  deps: scala.ValueOf[Deps],
